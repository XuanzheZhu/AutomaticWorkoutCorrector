...
function checkSideLift(keypoints, angles) {
  ...
  if (maxLeft > 0 && maxRight > 0) {
    if (maxLeft < 165 && maxRight < 165) {
      ...
      document.getElementById("poseFeedback").style.color="orange"
      ...
      document.getElementById("poseFeedback").style.color="mediumblue"
...
export function checkPoses(keypoints, angles, poseType, nowWorkout) {
  /*if (poseType == 0) {
